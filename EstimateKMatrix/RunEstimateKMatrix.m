...
% 2. Construct a 1m by 1m grid with 10mm tiles in the grid fram
...
% T_ow in the 4x4 transformation matric from grid to world.
T_ow = PositionGrid();
...
for CallImage = 1:nImages
    ...
    while Estimating == 1
        ...
        % T_cw is the 4x4 transformation matrix form camera to world
