function [] = ViewCamera(ObjectLines,KMatrix,CameraHeight,CameraWidth,...
    T_cw)
% ViewCamera
...
% CameraHeight i the number of vertical pixels.
...
% Transform the object into camera coordinates using the backlash 
% operator
ObjectLines = T_cw\ObjectLines;

% Project out the 4th coordinate and multiply by the the KMatrix
