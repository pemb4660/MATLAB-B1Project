...
GridWidth = 1000;
GridIncrement = 10;
CalibrationGrid = BuildGrid(GridIncrememt,GridWidth);
...
for CallImage = 1:nImages
    ...
    while Estimating == 1
        ...
        % 6. Add in some 'outliers' by replacing [u v]' with a point % somewhere in the image.
